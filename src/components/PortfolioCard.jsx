...
export function PortfolioCard(props) {
  ...
  return (
    <div className={`flex items-end overflow-hidden lg:bg-cover sm:bg-contain bg-center ${images} bg-no-repeat lg:h-screen h-96 card`}>
      <motion.div initial={{}} className="w-full px-8 py-4 overflow-hidden backdrop-blur-sm bg-spindle-800/60 hover:py-16 flex justify-between flex-row align-items delay-200	">
        <div>
        ...
        <a href={url} className="btn-primary w-auto h-fit mx-0 my-auto animate-none">visit site</a>
      </motion.div>
    </div>
  );
}
